...
public class SugerenciaTest {
    ...
    public void testExceptionTipoPrendas() throws SinPrendasDeTipoException{
    ...
    @Test
    public void testPrendaElegidaEsValida() throws SinPrendasDeTipoException{
        ...
        Sugerencia sugerencia =  new Sugerencia(persona);
        sugerencia.armarSugerencia(persona);
        List<Prenda> sugerenciaElegida = persona.elegirSugerencia(2);
        Assert.assertTrue(sugerencia.sugerenciaValida(sugerenciaElegida));
